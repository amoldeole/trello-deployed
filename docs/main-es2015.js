...
module.exports = __webpack_require__(/*! E:\Angular Projects\SuperDailyDemo\trello-dashboard\src\main.ts */"zUnb");
...
const routes = [
    ...
    { path: 'trello-dashboard', loadChildren: () => __webpack_require__.e(/*! import() | components-dashboard-dashboard-module */ "components-dashboard-dashboard-module").then(__webpack_require__.bind(null, /*! ./components/dashboard/dashboard.module */ "5+sL")).then(m => m.DashboardModule) },
    { path: '**', redirectTo: 'trello-dashboard', pathMatch: 'full' }
];
